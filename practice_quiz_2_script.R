...
analytic_data_male <- subset(analytic_data, sex=='Male', select=c(pos_affect, neg_affect, Neuroticism, Extraversion))
analytic_data_female <- subset(analytic_data, sex=='Female', select=c(pos_affect, neg_affect, Neuroticism, Extraversion))
